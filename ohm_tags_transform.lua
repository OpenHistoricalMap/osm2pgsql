...
-- since postgres only goes as far back as 4713 BC, we'll store the year in a new key
    ...
    year = string.match(keyvalues["start_date"], "^(-?%d+%d%d%d)")
      ...
      if (year ~= nil) then
        ...
        if (month == nil) then
          ...
          keyvalues["start_date"] = nil
          keyvalues["start_date_year"] = nil
      end
  end
    ...
    year = string.match(keyvalues["end_date"], "^(-?%d+%d%d%d)")
      ...
      if (year ~= nil) then
        ...
        if (month == nil) then
          ...
          keyvalues["end_date"] = nil
          keyvalues["end_date_year"] = nil
      end
  end
